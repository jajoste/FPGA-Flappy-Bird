...
HD_PWD='H:/Documents/ES3B2/lab5_a/lab5_a.runs/bg_green_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bg_green.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bg_green.tcl
