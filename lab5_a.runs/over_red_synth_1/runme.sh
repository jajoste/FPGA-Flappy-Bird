...
HD_PWD='H:/Documents/ES3B2/lab5_a/lab5_a.runs/over_red_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log over_red.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source over_red.tcl
