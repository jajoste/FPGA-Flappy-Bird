...
HD_PWD='H:/Documents/ES3B2/lab5_a/lab5_a.runs/pipe_blue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipe_blue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipe_blue.tcl
