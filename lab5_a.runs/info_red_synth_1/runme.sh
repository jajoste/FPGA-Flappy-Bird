...
HD_PWD='H:/Documents/ES3B2/lab5_a/lab5_a.runs/info_red_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log info_red.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source info_red.tcl
