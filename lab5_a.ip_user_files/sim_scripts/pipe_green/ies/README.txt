...
#
# Generated by export_simulation on Tue Apr 12 15:53:53 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './pipe_green.sh' script.

./pipe_green.sh -reset_run
...
./pipe_green.sh -noclean_files

For more information on the script, please type './pipe_green.sh -help'.
