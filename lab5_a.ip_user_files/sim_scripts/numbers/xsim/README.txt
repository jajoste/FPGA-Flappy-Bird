...
#
# Generated by export_simulation on Fri Apr 15 15:39:57 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './numbers.sh' script.

./numbers.sh -reset_run
...
./numbers.sh -noclean_files

For more information on the script, please type './numbers.sh -help'.
