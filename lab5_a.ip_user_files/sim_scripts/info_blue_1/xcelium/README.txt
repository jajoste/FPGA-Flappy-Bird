...
#
# Generated by export_simulation on Tue Apr 12 16:09:14 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './info_blue.sh' script.

./info_blue.sh -reset_run
...
./info_blue.sh -noclean_files

For more information on the script, please type './info_blue.sh -help'.
