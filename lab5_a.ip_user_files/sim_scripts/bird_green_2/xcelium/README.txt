...
#
# Generated by export_simulation on Tue Apr 12 15:20:01 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bird_green.sh' script.

./bird_green.sh -reset_run
...
./bird_green.sh -noclean_files

For more information on the script, please type './bird_green.sh -help'.
