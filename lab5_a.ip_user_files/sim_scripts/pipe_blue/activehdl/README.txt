...
#
# Generated by export_simulation on Tue Apr 12 15:54:34 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './pipe_blue.sh' script.

./pipe_blue.sh -reset_run
...
./pipe_blue.sh -noclean_files

For more information on the script, please type './pipe_blue.sh -help'.
