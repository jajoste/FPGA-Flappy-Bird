...
#
# Generated by export_simulation on Tue Apr 12 16:08:35 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './info_green.sh' script.

./info_green.sh -reset_run
...
./info_green.sh -noclean_files

For more information on the script, please type './info_green.sh -help'.
