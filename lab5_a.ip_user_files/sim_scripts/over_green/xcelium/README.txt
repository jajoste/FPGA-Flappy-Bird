...
#
# Generated by export_simulation on Fri Apr 15 18:55:01 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './over_green.sh' script.

./over_green.sh -reset_run
...
./over_green.sh -noclean_files

For more information on the script, please type './over_green.sh -help'.
