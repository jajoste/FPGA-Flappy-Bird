...
#
# Generated by export_simulation on Tue Apr 12 16:41:34 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bg_red.sh' script.
...
./bg_red.sh -noclean_files

For more information on the script, please type './bg_red.sh -help'.
