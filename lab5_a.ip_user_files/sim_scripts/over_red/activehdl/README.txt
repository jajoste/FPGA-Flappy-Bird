...
#
# Generated by export_simulation on Fri Apr 15 18:53:56 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './over_red.sh' script.

./over_red.sh -reset_run
...
./over_red.sh -noclean_files

For more information on the script, please type './over_red.sh -help'.
