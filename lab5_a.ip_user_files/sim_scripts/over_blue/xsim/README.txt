...
#
# Generated by export_simulation on Fri Apr 15 18:55:59 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './over_blue.sh' script.

./over_blue.sh -reset_run
...
./over_blue.sh -noclean_files

For more information on the script, please type './over_blue.sh -help'.
