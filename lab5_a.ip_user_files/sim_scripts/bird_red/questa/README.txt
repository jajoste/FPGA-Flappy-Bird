...
#
# Generated by export_simulation on Tue Apr 12 15:21:27 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bird_red.sh' script.

./bird_red.sh -reset_run
...
./bird_red.sh -noclean_files

For more information on the script, please type './bird_red.sh -help'.
