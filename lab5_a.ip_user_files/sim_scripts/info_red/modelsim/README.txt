...
#
# Generated by export_simulation on Tue Apr 12 16:07:50 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './info_red.sh' script.

./info_red.sh -reset_run
...
./info_red.sh -noclean_files

For more information on the script, please type './info_red.sh -help'.
