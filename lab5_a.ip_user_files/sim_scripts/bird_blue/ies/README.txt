...
#
# Generated by export_simulation on Tue Apr 12 15:21:04 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bird_blue.sh' script.

./bird_blue.sh -reset_run
...
./bird_blue.sh -noclean_files

For more information on the script, please type './bird_blue.sh -help'.
