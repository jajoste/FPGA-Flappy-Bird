...
#
# Generated by export_simulation on Tue Apr 12 16:42:11 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bg_green.sh' script.

./bg_green.sh -reset_run
...
./bg_green.sh -noclean_files

For more information on the script, please type './bg_green.sh -help'.
