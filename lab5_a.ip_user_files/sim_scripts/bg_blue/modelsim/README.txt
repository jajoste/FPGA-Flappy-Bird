...
#
# Generated by export_simulation on Tue Apr 12 16:42:55 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bg_blue.sh' script.

./bg_blue.sh -reset_run
...
./bg_blue.sh -noclean_files

For more information on the script, please type './bg_blue.sh -help'.
